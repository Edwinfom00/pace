...
export function TransactionErrorState({
  ...
  return (
    <main className="mx-auto w-full max-w-[1440px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <section className="flex min-h-[280px] flex-col items-center justify-center rounded-[12px] border border-[#f1d9d5] bg-[#fffdfd] px-6 text-center">
        <span className="flex size-10 items-center justify-center rounded-[12px] bg-[#fff2f0] text-[#b5473c]"><HiOutlineExclamationTriangle aria-hidden="true" className="size-5" /></span>
