...
const labels: Record<PaceAssistantLanguage, PaceAssistantLabels> = {
  ...
  fr: {
    ...
    newLineHint: "Entrée pour envoyer · Maj + Entrée pour une nouvelle ligne", previous: "Précédent", close: "Fermer l’assistant", collapse: "Réduire l’assistant", expand: "Ouvrir l’assistant", sending: "Envoi de votre question...", retrieving: "Recherche des informations financières...", checking: "Vérification des détails...", waitingApproval: "En attente de votre approbation...", verifying: "Vérification du résultat...", preparingApproval: "Préparation de votre approbation...", verifiedByPace: "Vérifié par Pace", actionFailed: "Pace n’a pas pu finaliser cette action.", actionPrepared: "Préparé. Vérifiez les détails avant de demander l’approbation.", transfer: "Transfert", income: "Revenu", expense: "Dépense", planChange: "Modification du plan", amount: "Montant", date: "Date", details: "Détails", status: "Statut",
  },
  de: {
