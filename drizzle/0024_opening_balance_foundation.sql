...
-- transaction commits. The dependent schema/data work therefore lives in
-- 0025_opening_balance_foundation_schema.sql.
...
SELECT
  ...
  jsonb_build_object(
    'migration', '0024_opening_balance_foundation',
